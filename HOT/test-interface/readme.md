...
an autoscaling group with 1 instance

autoscale by alarm call to an external service, that service will call the openstack api to change flavor of the instance
